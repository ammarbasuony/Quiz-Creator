...
const UpdateQuiz = () => {
  ...
  const getQuiz = () => {
    ...
    setQuizUrl(quiz?.url);
    setQuizQuestions(quiz?.questions_answers);
  };
        ...
        <div className="col-span-6 sm:col-span-6 mt-4" key={i}>
          ...
          <div className="flex items-center gap-1 mt-2">
            ...
            >
              ...
              <option
                selected={question.answers[i].is_true === "true"}
                value={true}
              >
                True
              </option>
              <option
                selected={question.answers[i].is_true === "false"}
                value={false}
              >
                False
              </option>
  ...
  const saveQuiz = () => {
    ...
    const index = quizes.findIndex((item) => item.id === parseInt(id));
  ...
  return (
    <div className="min-h-screen bg-slate-200 pb-10">
      ...
      <div className="mt-7">
        <div className="container">
          {isAdded ? (
            <AlertBox message="Quiz Updated Successfully" />
          ) : (
